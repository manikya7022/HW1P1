...
auto_version = '3.0.1'
print("version: " + str(auto_version))
SEED = 0
np.random.seed(SEED)
n_tests = 3
atol_threshold = 1e-4
...
if DEBUG_AND_GRADE_MLP0:
    ...
    for i in range(n_tests):
        ...
        # Test forward
        # Using torch.linear to get the correct answer
        ...
        # Using model Linear layer to get the answer
        ...
        # Compare the models answer with the correct answer
...
if DEBUG_AND_GRADE_MLP1:
    ...
    for i in range(n_tests):
        ...
        # Using models Linear layer to get the model answer
        ...
        # Use your Linear layer to get the model answer
        mlp1.backward(dLdA2)
        dLdA0_ = mlp1.dLdA0
        dLdZ0_ = mlp1.dLdZ0
...
if DEBUG_AND_GRADE_SGD_M:
    ...
    print("\n──────────────────────────────────────────")
    print("SGD with Momentum | OUTPUT")
    print("──────────────────────────────────────────")
...
if DEBUG_AND_GRADE_BATCHNORM:
    ...
    print("\n──────────────────────────────────────────")
    print("BATCHNORM FORWARD (Eval) | MODEL OUTPUT")
    print("──────────────────────────────────────────")
...
if DEBUG_AND_GRADE_BATCHNORM:
    ...
    print("\n──────────────────────────────────────────")
    print("BATCHNORM FORWARD (Train) | MODEL OUTPUT")
    print("──────────────────────────────────────────")
...
if DEBUG_AND_GRADE_BATCHNORM:
    ...
    print("\n──────────────────────────────────────────")
    print("BATCHNORM BACKWARD |  OUTPUT")
    print("──────────────────────────────────────────")
...
for i, (key, value) in enumerate(SCORE_LOGS.items()):
    ...
    print("Test ", index_str, status_str, key, sep="")
